...
/**
 * Servlet implementation class criminalnode4
 */
@WebServlet("/criminalnode4")
public class criminalnode4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public criminalnode4() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("node1 post method called");
		String uri=request.getRequestURI();
		System.out.println("get::uri::"+uri);
		if(uri.equals("/criminalnode4/node4"))
		{
		...
		else if(uri.equals("/criminalnode4/no4"))
		{
			String dest=request.getParameter("dest");
			String title=request.getParameter("title");
			if(title!=null)
