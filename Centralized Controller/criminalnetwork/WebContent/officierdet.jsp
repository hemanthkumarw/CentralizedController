...
try
{
 	...
 	while(res.next())
 	{
        ...
        <tr>
        <td><%out.write(na2); %></td>
        <td><%out.write(email2); %></td>
        <td><%out.write(add2); %></td>
        <td><%out.write(numm2); %></td>
        <td><%out.write(ddd1); %></td>
        </tr>
       <% 
 	}
 	%>
 	...
 	<div align="center">
 	<marquee direction="left" scrollamount="5"><h2>YOU NEED AUTHENTICATION TO SEE THE DECRYPTED DETAILS</h2></marquee>
 	<a href="off.jsp" style="text-decoration:none">AUTHENTICATE</a>
 	</div>
 	<% 
}
catch(Exception e)
